...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ABUY SHOP");
        ...
        btnproses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (total >=200000){
                    txtbonus.setText("Bonus : Bedak");
                } else if (total >=50000){
                    txtbonus.setText("Bonus : Lipstick");
                } else  if (total >=40000){
                    txtbonus.setText("Bonus : Masker Wajah");
                } else {
